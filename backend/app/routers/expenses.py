...
async def create_expense(
    ...
    try:
        return await expense_service.create_expense(db, trip_id, user.id, payload.model_dump())
...
async def delete_expense(trip_id: UUID, expense_id: UUID, db: DbSession, _: Membership):
    try:
...
async def create_settlement(
    ...
    try:
        return await expense_service.create_settlement(db, trip_id, user.id, payload.model_dump())
